...
: on_init
    ...
    I[ : win1
        ...
        (.win1-hover-0 'foobar {} )dpg:tooltip

        (((
        (.add_text 'Hello'World'II {} 'foobar2 }.tag= )dpg? 'label_tag !
        I[ : ULID-* (.add_text ("The hover II") {} )dpg ; ]I
        ...
        (.add_button { 'callback 'press-me 'label 'Press'me } )dpg drop
    ...
    (.win1 {} 
            'Hello            }.label=
            ("on-win0-close") }.on_close=
            500 }.width= 500 }.height=
            )DPG:window

    I[ : on-win0-close 'Window'Closed . CR ; ]I
